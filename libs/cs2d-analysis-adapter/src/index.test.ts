...
describe("cs2d analysis adapter", () => {
  it.each([
    ...
    ["cs2-demo-parser-wasm@0.0.0+cs-coach.hurt-events.v1.shot-identity.v2.ammo-clip.v2.bomb-identity.v1.death-identity.v1.frame-identity.v1.active-weapon-identity.v1.grenade-inventory.v1.primary-weapon.v1", "/hurt-events.v1/shot-identity.v2/ammo-clip.v2/bomb-identity.v1/death-identity.v1/frame-identity.v1/active-weapon-identity.v1/grenade-inventory.v1/primary-weapon.v1"],
