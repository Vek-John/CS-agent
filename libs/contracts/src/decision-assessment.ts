...
export interface DecisionAssessmentPacket {
  projectionVersion: typeof DECISION_ASSESSMENT_VERSIONS.projection | typeof DECISION_ASSESSMENT_VERSIONS.projectionWithUserContext | typeof DECISION_ASSESSMENT_VERSIONS.projectionWithReturnAndFire;
  questionVersion: typeof DECISION_ASSESSMENT_VERSIONS.questions | typeof DECISION_ASSESSMENT_VERSIONS.questionsReturnAndFire;
  ...
  state: {
    ...
    observations: readonly { alias: string; kind: ObservationClaimType; source: "DEMO_OBSERVER" | "USER_PROVIDED"; confidence: number; ageSeconds: number; shared: boolean; reportedContext?: UserTacticalContext }[];
  };
