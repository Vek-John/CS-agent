...
const CueCaseSchema = z.object({
  ...
  previousLearningThread: ThreadSchema.optional(),
  acceptedDisagreement: UserReflectionSchema.optional(),
...
export function reviseDiagnosis(raw: ReviseTeachingDiagnosisInput): TeachingDiagnosisOutput {
  ...
  const revisedCase: CueCase = {
    ...
    previousLearningThread: previous.learningThread,
    acceptedDisagreement: disagreement,
