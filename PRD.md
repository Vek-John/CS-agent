...
- 在关键决策发生前暂停；
- 还原玩家当时知道什么、不知道什么；
- 解释玩家为什么会输掉这个局部，以及更好的选择；
- 必要时回放、画线、标点位，并在同一张全知 2D 地图上推进结果；
- 用相似职业回合作为补充证据；
- 回答用户针对当前画面的追问；
...
理想讲解点是“玩家即将作出选择”的时刻，而不是死亡之后。系统先冻结当时局势，再解释可用信息、可能选择与风险，然后播放结果。
...
1. 在决策前暂停；
2. 显示玩家当时已知信息；
3. 教练直接给出判断与理由，不要求用户先预测或作答；用户可在讲解后补充当时意图；
4. 标出玩家、队友、关键区域和风险枪线；
5. 说明可选动作及其取舍；
6. 播放用户真实选择和结果；
7. 必要时回放；
