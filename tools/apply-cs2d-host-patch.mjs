...
function inspectPatchedCheckout(upstream) {
  ...
  // Fixed positions correspond to 0006 through 0027; appending a patch must not retarget an older upgrade.
